...
public class MenuContenidoTemaUno extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        layouts = new int[]{
                ...
                R.layout.contenido_tema_uno_parte2,
                R.layout.contenido_tema_uno_parte3ra,
                R.layout.contenido_tema_uno_patre_cuatro,
                R.layout.contenido_tema_uno_patre_cinco,
                R.layout.contenido_tema_uno_patre_seis};
